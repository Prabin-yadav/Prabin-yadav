...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/prabin-yadav-5711a131a)
...
- 🌱 Always learning — Excel/BI tooling, distributed systems, and cleaner system design.
- 📫 Reach me at **prawinyadav2060@gmail.com**
...
class Prabin:
    ...
    def collaborate(self, you):
        return "let's ship something 🚀" if you.is_curious else "let's talk anyway"
```
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h4>☁️ Cloud Data Warehouse & ETL Pipeline</h4>
      <em>Pharma Analytics · 2026</em>
      <p>End-to-end cloud ETL pipeline transforming pharma operational data from SQL Server into a star-schema, loaded into AWS RDS PostgreSQL, with Tableau dashboards for sales & inventory BI.</p>
      <b>Stack:</b> Python · Pandas · SQLAlchemy · SQL Server · AWS RDS · Tableau
    </td>
    <td width="50%" valign="top">
      <h4>🌾 Smart Agriculture AI System</h4>
      <em>Multi-Model ML Case Study · 2026</em>
      <p>Led architecture for a 3-model ML pipeline (crop, fertilizer, yield recommendation) enriched with a 641-district rainfall lookup, delivering one actionable recommendation card for farmers.</p>
      <b>Stack:</b> Python · XGBoost · Random Forest · Gradient Boosting · Scikit-learn
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h4>📋 CapManage</h4>
      <em>Academic Submission & Evaluation System · 2024–2025</em>
      <p>Full-stack TypeScript monorepo with JWT-secured role-based dashboards, Socket.IO real-time notifications, CSV/PDF reporting, and one-command Docker Compose deployment.</p>
      <b>Stack:</b> TypeScript · Next.js 14 · Node.js · Express · MongoDB · Docker · Socket.IO
    </td>
    <td width="50%" valign="top">
      <h4>🎬 Edit-Vault</h4>
      <em>AI-Powered Media Management Platform · 2024</em>
      <p>Dual-dashboard (Admin/Client) media platform integrating BLIP, CLIP, and OpenCV for automatic captioning, semantic tagging, and face recognition — eliminating manual metadata work.</p>
      <b>Stack:</b> Node.js · Express · MongoDB · React · PyTorch · OpenCV · NLTK
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h4>💼 Skill-Based Freelancer Hiring Platform</h4>
      <em>Desktop App · 2023</em>
      <p>JavaFX desktop marketplace matching freelancers to skill-tagged projects, with a normalized MySQL schema (Users, Projects, Skills, Proposals, Payments) and full JDBC CRUD operations.</p>
      <b>Stack:</b> Java · JavaFX · MySQL · JDBC
    </td>
    <td width="50%" valign="top">
      <h4>✨ More on the way</h4>
      <p>Always shipping something new — check my pinned repos for the latest work in progress.</p>
      <a href="https://github.com/Prabinyadav?tab=repositories">→ Browse all repositories</a>
    </td>
  </tr>
</table>
...
```text
2026   🎤  Presented "AI-Driven Tag Generation for Media Searchability" — SCI-2026, Swinburne Vietnam, Hanoi
2023   🇳🇵  All Nepal Rank 96 — Institute of Engineering (IOE) Entrance Examination
2023   🎓  COMPEX Scholarship — Indian Embassy merit-based higher education scholarship
```
...
<p align="center">
  <img height="165" src="https://github-readme-stats.vercel.app/api?username=Prabinyadav&show_icons=true&locale=en&theme=radical&hide_border=true" alt="GitHub Stats" />
  <img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=Prabinyadav&layout=compact&locale=en&theme=radical&hide_border=true" alt="Top Languages" />
</p>
